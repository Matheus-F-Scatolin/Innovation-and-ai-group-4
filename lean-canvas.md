...
## 2. Customer Segments — ⏳ pending

Draft raw material (from personas): user = teachers (Lourdes/Andrés/Renata archetypes);
buyer = directors (Beatriz/Fernando/Patricia archetypes); market scope = good private
preparatorias/bachilleratos in Mexico (ages 15–18), not necessarily elite, reached
through a teammate's network.
...
## 8. Key Metrics — ⏳ pending

## 9. Unfair Advantage — ⏳ pending
Candidate from Block 1: direct access to Mexican private-prepa teachers/directors via a
teammate's network (incl. Emiliano).
...
PROGRESS — Block 1 (Problem) is COMPLETE. The agreed Problem box:
- P1 (teacher): Teachers in Mexican private prepas can no longer verify from
  out-of-class work whether a student actually understood anything, because AI produces
  competent-looking submissions.
...
YOUR NEXT ACTION: Start Block 2 — Customer Segments. Ask us to paste what we have, then
ask your 3–5 sharp questions. Push us to narrow beyond "private prepa teachers in
Mexico" to an exact early segment we can interview 10–20 people from in the next 30
days. Be direct, skeptical, and practical.
```
